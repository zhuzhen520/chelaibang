<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:74:"/www2/wwwroot/Zhu/CRMEB/application/admin/view/order/store_order/index.php";i:1552662433;s:67:"/www2/wwwroot/Zhu/CRMEB/application/admin/view/public/container.php";i:1552637812;s:68:"/www2/wwwroot/Zhu/CRMEB/application/admin/view/public/frame_head.php";i:1552637812;s:63:"/www2/wwwroot/Zhu/CRMEB/application/admin/view/public/style.php";i:1552637812;s:70:"/www2/wwwroot/Zhu/CRMEB/application/admin/view/public/frame_footer.php";i:1552637812;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
                ...
                <div class="layui-card-body">
                    ...
                    <script type="text/html" id="act">
                        ...
                        <ul class="layui-nav-child layui-anim layui-anim-upbit">
                            <li>
                                <a href="javascript:void(0);" onclick="$eb.createModalFrame('{{d.nickname}}-订单详情','<?php echo Url('order_info'); ?>?oid={{d.id}}')">
                        ...
                        <ul class="layui-nav-child layui-anim layui-anim-upbit">
                            ...
                            <li>
                                <a  href="javascript:void(0);" onclick="$eb.createModalFrame('去送货','<?php echo Url('delivery'); ?>?id={{d.id}}',{w:400,h:300})">
                                    <i class="fa fa-motorcycle"></i> 去送货1
                                </a>
                            </li>
                            <li>
                                <a lay-event='marke' href="javascript:void(0);" >
                        ...
                        <ul class="layui-nav-child layui-anim layui-anim-upbit">
                            ...
                            <li>
                                <a  href="javascript:void(0);" onclick="$eb.createModalFrame('去送货','<?php echo Url('delivery'); ?>?id={{d.id}}')">
                                    <i class="fa fa-motorcycle"></i> 去送货2
                                </a>
                            </li>
